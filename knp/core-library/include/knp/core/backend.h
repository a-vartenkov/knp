...
public:
     ...
     *
     * @throw exception if the @p projections parameters contains unsupported projection types.
     */
     ...
     *
     * @throw exception if the @p populations parameter contains unsupported population types.
     */
